...
bootstrap_typeahead_version = 4.0.1
...
setup:
	...
	if [ ! -d lib/bootstrap-typeahead ]; then curl -O -L https://github.com/bassjobsen/Bootstrap-3-Typeahead/archive/$(bootstrap_typeahead_version).zip && unzip $(bootstrap_typeahead_version).zip && mv Bootstrap-3-Typeahead-$(bootstrap_typeahead_version) lib/bootstrap-typeahead && rm $(bootstrap_typeahead_version).zip; fi;
